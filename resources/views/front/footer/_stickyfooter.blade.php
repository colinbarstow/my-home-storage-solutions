<div class="sticky-footer sticky-content fix-bottom">
    ...
    <a href="{{ route('blog') }}" class="sticky-link">
    ...
    <div class="dropdown cart-dropdown dir-up">
        <a href="{{ route('cart') }}" class="sticky-link cart-toggle">
            ...
            <div class="products scrollable">
                <div class="product product-cart">
                    ...
                    <figure class="product-media">
                        <a href="#">
                            <img src="{{ asset('front/images/cart/product-1.jpg') }}" alt="product" width="90" height="90" />
                        </a>
                ...
                <div class="product product-cart">
                    ...
                    <figure class="product-media">
                        <a href="#">
                            <img src="{{ asset('front/images/cart/product-2.jpg') }}" alt="product" width="90" height="90" />
                        </a>
                        <button class="btn btn-link btn-close">
                            <i class="fas fa-times"></i>
                        </button>
