...
@section('content')
    ...
    <div class="card card-custom gutter-b example example-compact">
        ...
        <!--begin::Form-->
        <form method="POST" action="{{ route('admin.parallax.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-2 col-form-label">Pre Title</label>
                    <div class="col-10">
                        <input class="form-control" name="pre_title" type="text" placeholder="Parallax Pre Title" value="{{ old('pre_title') }}">
                        @error('pre_title')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="title" type="text" placeholder="Parallax Title" value="{{ old('title') }}">
                        @error('title')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="sub_title" type="text" placeholder="Parallax Sub Title" value="{{ old('sub_title') }}">
                        @error('sub_title')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="button_text" type="text" placeholder="Parallax button text" value="{{ old('button_text') }}">
                        @error('button_text')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="link" type="text" placeholder="Parallax button URL" value="{{ old('link') }}">
                        @error('link')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
