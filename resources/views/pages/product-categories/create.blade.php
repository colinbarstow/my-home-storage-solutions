...
@section('content')
        ...
        <form method="POST" action="{{ route('admin.product-categories.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" name="title" type="text" placeholder="Product Category Title" value="{{ old('title') }}">
                        @error('title')
    ...
    @else
        <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
                <h3 class="card-title">You do not have permission to create product categories please contact a system admin if you require access</h3>
            </div>
        </div>
    @endif
