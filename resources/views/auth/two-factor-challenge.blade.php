        ...
        <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
            ...
            <div class="d-flex flex-column-fluid flex-center">
                ...
                <div class="login-form login-signin">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{ url('/two-factor-challenge') }}" novalidate="novalidate" id="kt_login_signin_form">
                        @csrf
                        <!--begin::Title-->
...
{{--									<a href="javascript:;" id="kt_login_signup" class="text-primary font-weight-bolder">Create an Account</a></span>--}}
                        ...
                        <div class="form-group">
                            <label class="font-size-h6 font-weight-bolder text-dark">Authentication Code</label>
                            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="text" name="code" autocomplete="off" />
                        </div>
